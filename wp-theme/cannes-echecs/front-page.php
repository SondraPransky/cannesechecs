<?php
/**
 * front-page.php — Accueil Cannes Échecs
 * Les 4 dernières actualités sont rendues côté PHP (ce_actu_card).
 * Le widget héro est piloté par ACF (Réglages CE → Infos Club) via CE_HERO_MODE.
 */
get_header(); ?>
...
<div id="page-home" class="page active">
      ...
      <div class="home-hero-grid">
        <div>
          ...
          <div class="home-hero-btns">
            <a class="btn btn-gold" href="<?php echo esc_url(home_url('/adhesion/')); ?>">Rejoindre le club →</a>
            <a class="btn btn-outline-white" href="<?php echo esc_url(home_url('/club/')); ?>">Découvrir le club</a>
          </div>
        </div>
        <div>
  ...
  <section class="section-actus">
    <div class="container">
      <div class="section-actus-header">
        ...
        <a class="link-all" href="<?php echo esc_url(home_url('/actualites/')); ?>">Toutes les actualités →</a>
      </div>
      <div class="actu-grid">
        <?php
        $latest = get_posts(['post_type' => 'actualite', 'numberposts' => 4, 'post_status' => 'publish']);
        if ($latest) {
            foreach ($latest as $p) {
                echo ce_actu_card($p, false);
            }
        } else {
            echo '<p style="color:var(--muted);font-style:italic">Les premières actualités arrivent bientôt.</p>';
        }
        ?>
      </div>
    </div>
    ...
    <div class="container">
      <div class="fij-grid">
        <div class="fij-text">
          ...
          <div class="fij-btns">
            <a class="btn btn-gold" href="<?php echo esc_url(home_url('/fij/')); ?>">Découvrir le FIJ 2027 →</a>
            <button class="btn btn-outline-white" onclick="haOpen(HELLOASSO.fij)">S'inscrire sur HelloAsso</button>
          </div>
        ...
        <div>
          <div class="fij-cd-box">
            ...
            <a class="btn btn-gold btn-full" style="margin-bottom:12px" href="<?php echo esc_url(home_url('/fij/')); ?>">Voir les tarifs & s'inscrire →</a>
  ...
  <section class="section-cta">
    <div class="cta-inner">
      ...
      <div class="cta-btns">
        <a class="btn btn-gold btn-lg" href="<?php echo esc_url(home_url('/adhesion/')); ?>">S'inscrire maintenant →</a>
        <a class="btn btn-outline-white btn-lg" href="<?php echo esc_url(home_url('/club/')); ?>">En savoir plus</a>
      </div>
