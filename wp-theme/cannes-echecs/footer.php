    ...
    <div class="footer-grid" style="max-width:900px;margin:0 auto">
      <div>
        ...
        <div class="footer-social" style="display:flex;gap:10px;margin-top:18px">
          ...
          <a href="https://www.instagram.com/cannes_echecs" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:5px;font-size:11px;font-family:'Montserrat',sans-serif;font-weight:600;letter-spacing:.06em;color:rgba(255,255,255,.5);text-decoration:none;padding:5px 10px;border:1px solid rgba(255,255,255,.12);border-radius:6px;transition:color .2s,border-color .2s" onmouseover="this.style.color='#C9A84C';this.style.borderColor='var(--gold-tint-border)'" onmouseout="this.style.color='rgba(255,255,255,.5)';this.style.borderColor='rgba(255,255,255,.12)'">Instagram</a>
          <a href="https://x.com/CannesChessClub" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:5px;font-size:11px;font-family:'Montserrat',sans-serif;font-weight:600;letter-spacing:.06em;color:rgba(255,255,255,.5);text-decoration:none;padding:5px 10px;border:1px solid rgba(255,255,255,.12);border-radius:6px;transition:color .2s,border-color .2s" onmouseover="this.style.color='#C9A84C';this.style.borderColor='var(--gold-tint-border)'" onmouseout="this.style.color='rgba(255,255,255,.5)';this.style.borderColor='rgba(255,255,255,.12)'">X / Twitter</a>
        </div>
      </div>
